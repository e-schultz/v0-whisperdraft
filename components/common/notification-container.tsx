...
// Update the NotificationContainer component to position at the bottom of the screen
export function NotificationContainer({ children }: { children: ReactNode }) {
  return (
    <div className="fixed bottom-0 left-0 right-0 z-50 p-2 bg-gray-800/20 dark:bg-black/30 backdrop-blur-sm">
      <div className="flex flex-col items-center space-y-1.5 max-w-md mx-auto">{children}</div>
    </div>
  )
}
