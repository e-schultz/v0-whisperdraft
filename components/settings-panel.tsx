...
export default function SettingsPanel({ onClose }: { onClose: () => void }) {
  ...
  const [hasServerApi, setHasServerApi] = useState(false)
  ...
  // Add a function to check server API availability
          ...
          <div className="space-y-4">
            ...
            <div>
              <label className="flex justify-between text-sm font-medium text-gray-700 dark:text-gray-300 mb-1">
                ...
                {hasServerApi && (
                  <span className="text-green-600 dark:text-green-400 text-xs ml-2">Server API available</span>
                )}
              </label>
                ...
                <input
                  ...
                  className={`w-full px-3 py-2 border ${
                    apiKeyError ? "border-red-300 dark:border-red-600" : "border-gray-300 dark:border-gray-600"
                            ...
                            bg-white dark:bg-gray-700 text-gray-800 dark:text-gray-200`}
                  placeholder={hasEnvApiKey || hasServerApi ? "Using server API (optional)" : "sk-..."}
                />
                {isValidatingApiKey && (
              ...
              <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">
                {hasServerApi
                  ? "Server API is available. You can optionally use your own key instead."
                  : hasEnvApiKey
